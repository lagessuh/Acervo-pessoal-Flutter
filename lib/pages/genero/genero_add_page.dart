                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          TextButton(
                            onPressed: () async {
                              final genero = Genero(nome: _nomeController.text);
                              bool result = await generoServices.addGenero(
                                  genero: genero);
                              if (result) {
                                print(
                                    'Gênero adicionado com sucesso: ${genero.id}');
                              } else {
                                print('Erro ao adicionar gênero');
                              }
                              _nomeController.clear();
                              Navigator.of(context).pop();
                            },
